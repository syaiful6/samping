...
from samping.messages import Message, TaskMessageV1, TaskMessageV2, TaskMessageBody
...
def test_encode_task_message_v2():
    task = TaskMessageV2(
        ...
        body=TaskMessageBody([], {}, {"callbacks": None, "errbacks": None, "chain": None, "chord": None})
    )
